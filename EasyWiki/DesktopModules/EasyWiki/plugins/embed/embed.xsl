...
>
    ...
    <xsl:template match="/">
        ...
        <mdo:header position="page">
            <script type="text/javascript" src="{concat($apppath, 'DesktopModules/EasyWiki/js/jwplayer/jwplayer.js')}"></script>
        </mdo:header>
        ...
        <script type="text/javascript">
            ...
            flashplayer: '{{concat($apppath, 'DesktopModules/EasyWiki/js/jwplayer/player.swf')}}',
            file: '{{$url}}',
            height: {{$frameHeight}},
            width: {{$frameWidth}},
            ...
            'modes': [
            {type: 'html5'},
            {type: 'flash', src: '{{concat($apppath, 'DesktopModules/EasyWiki/js/jwplayer/player.swf')}}'},
            {type: 'download'}
            ]
            });
            });</script>
